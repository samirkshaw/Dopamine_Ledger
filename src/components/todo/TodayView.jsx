...
import { Check, Plus, X, ChevronsRight, Trash2 } from 'lucide-react';
...
export default function TodayView({ tasks, categories, onToggle, onAddTask, onSetPlannedDate }) {
  ...
  return (
    <div>
      ...
      {/* ── Quick-add bar ─────────────────────────────────────────────────── */}
      <div style={{ background: C.panel, border: `1px solid ${C.line}`, borderRadius: 14, padding: 12, marginBottom: 18, display: 'flex', gap: 8 }}>
        <input
          value={quickTitle}
      ...
      <div style={{ background: C.panel, border: `1px solid ${C.line}`, borderRadius: 16, padding: 16 }}>
        <div style={{ fontFamily: "'Poppins',sans-serif", fontWeight: 600, fontSize: 15, marginBottom: 12 }}>
          Today's Checklist
        </div>
